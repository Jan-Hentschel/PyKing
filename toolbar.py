...
class Toolbar:
    def __init__(self, root):
        ...
        self.save_grid_as_button.pack()
        self.save_grid_button.pack()
        self.load_grid_button.pack()
        self.excecute_code_button.pack(side="left")
        self.stop_code_execution_button.pack()
        self.tick_rate_slider.pack(side="left")
        self.pick_add_hamster_button.pack()
        self.pick_subtract_hamster_button.pack()
        self.pick_make_wall_button.pack()
