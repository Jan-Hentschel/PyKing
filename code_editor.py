...
def load_into_editor(content):
    code_editor_widget.delete(1.0,END)
    code_editor_widget.insert(tk.END, content)

def getStringFromEditor():
    return code_editor_widget.get("1.0",END)